...
export default function Footer() {
    return (
        <footer className='justify-between'>
            <div class="text-gray-600 body-font w-full">
                <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col justify-between">
                    ...
                    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">Copyright © 2024 Orato
                        <Link to="" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank"></Link>
                    </p>
