...
export default function PageNotFound() {
    return (
        <section class="min-h-screen py-2 mx-auto lg:flex lg:items-center lg:gap-12">
            <div class="w-full lg:w-1/2">
                <p class="px-5 text-sm font-medium text-green-500">404</p>
                <h1 class="px-5 mt-3 text-2xl font-semibold text-white md:text-3xl">Page not found</h1>
                <p class="px-5 mt-4 text-gray-300">Sorry, the page you are looking for doesn't exist.Here are some helpful links:</p>
                <div class="px-5 flex items-center mt-6 gap-x-3">
            ...
            <div class="relative mt-8 w-1/2 lg:mt-0 overflow-x-hidden">
