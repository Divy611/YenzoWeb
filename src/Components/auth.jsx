...
const AuthFields = ({ title }) => {
    return (
        <div className="py-10 2xl:py-56 flex flex-col items-center text-center bg-[#16151A]">
            ...
            <div className='w-1/3 px-3 py-5'>
                <button className='bg-green-600 rounded-lg w-full py-4 text-white font-semibold'>{title}</button>
            </div>
            <div className='w-1/3 px-3'>
            ...
            <h1 className='text-white'>Don't have an account? <a href="/chat" className='text-green-600'>Sign Up Today!</a></h1>
        </div>
    )
}
