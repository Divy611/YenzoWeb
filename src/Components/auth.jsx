        ...
        <div className="py-10 2xl:py-56 flex flex-col items-center text-center bg-[#16151A]">
            ...
            <div className='w-1/3 px-3 py-5'>
                <div className="border border-green-500 rounded-lg">
                    <input type="email" placeholder='Email' className='w-full bg-transparent p-4 rounded-lg text-lg text-white' />
                </div>
            </div>
            <div className='w-1/3 px-3'>
                <div className="border border-green-500 rounded-lg">
                    <input type="password" placeholder='Password' className='w-full bg-transparent p-4 rounded-lg text-lg text-white' />
                </div>
            </div>
            <div className='w-1/3 px-3 py-5'>
