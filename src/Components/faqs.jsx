        ...
        <div className="h-screen overflow-hidden py-12">
            <div className="h-full overflow-y-auto" ref={faqRef} onWheel={handleWheel}>
                <div className="p-10 flex justify-between">
                    ...
                    <div className="w-1/2">
                        <div ref={firstQuestionRef}><FAQ question={"What is Orato, and how does it work?"} answer={"Orato is an AI-powered speech coaching platform that helps professionals and students improve their communication skills. It uses advanced speech recognition, natural language processing, and computer vision to analyze your speech, body language, and content during practice sessions. Based on this comprehensive analysis, Orato provides real-time feedback to help you enhance your speaking abilities."} /></div>
                        <FAQ question={"Who is Orato for?"} answer={"Orato is designed for a wide range of users, including:"} bullet1={"Professionals looking to improve their communication skills for career advancement."} bullet2={"Students preparing for interviews, presentations, or public speaking events."} bullet3={"Non-native English speakers seeking to strengthen their English fluency and confidence."} bullet4={"Aspiring public speakers, entrepreneurs, and business leaders."} />
                        <FAQ question={"Can Orato be used for team or group training?"} answer={"Yes, Orato offers enterprise-level solutions that cater to the needs of teams and organizations. The key features of the Orato Enterprise plan include:"} bullet1={"Customized training modules and scenarios based on company-specific requirements."} bullet2={"Team performance analytics and progress tracking for managers and L&D professionals."} bullet3={"Dedicated account management and onboarding support for seamless implementation."} bullet4={"Bulk licensing and discounts for organizations investing in communication skill development."} />
                        <FAQ question={"How much does Orato cost?"} answer={"Orato offers a freemium pricing model:"} bullet1={"The 'Orato Basic' free tier provides basic speech analysis and limited practice sessions."} bullet2={"The 'Orato Pro' premium plan, priced at ₹199/month or ₹1,999/year, unlocks unlimited practice, real-time feedback, and advanced coaching features."} bullet3={"The 'Orato Enterprise' plan is designed for organizations and includes customized training modules, team analytics, and dedicated support."} />
